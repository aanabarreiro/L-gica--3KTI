...
//propriedade length diz a quantidade de itens na lista

const pokemon = ["Bulbassauro", "Suirtle", "charmander"]
console.log(pokemon.length)

//includes

const series = ["breaking bad", "got"]
series.includes("got")// true
